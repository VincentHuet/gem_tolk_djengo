...
1 configuration de Devise :
 ...
 1-1 Si devise n'est pas installé :

  1-1-1 ajouter à votre gem file :
    gem 'devise'
...
Modifie your abilyt.rb model and add this line :

  can :manage, :all

add that gem to your gem file :

  gem 'tolk_engine', :git => 'git://github.com/VincentHuet/gem_tolk_djengo.git'

add following lines to your routes.rb
